                ...
                <div className="mb-6 text-center">
                    <div className='flex justify-center gap-8 mb-5'>
                        <div className='grid gap-2'>
                            <p className='relative'>ผู้อนุมัติ(จ่ายงาน) : ............................................
                                {properties?.["ผู้อนุมัติ(จ่ายงาน)"]?.files?.[0]?.external?.url && (
                                    <img
                                        className="absolute -top-12 h-24 left-32"
                                        src={properties?.["ผู้อนุมัติ(จ่ายงาน)"]?.files[0]?.external?.url}
                                        alt={properties?.["ผู้อนุมัติ(จ่ายงาน)"]?.files[0]?.name}
                                    />
                                )}
                            </p>
                            <p>( {properties?.["ชื่อผู้อนุมัติ(จ่ายงาน)"]?.rich_text?.[0]?.text?.content || "\u00A0".repeat(40)} )</p>
                            <p>วันที่ :
                                <span className="font-medium underline decoration-dotted underline-offset-4 decoration-1.5">
                                    ㅤ
                                    {properties?.["วันที่เซ็นอนุมัติ(จ่ายงาน)"]?.date?.start
                                        ? new Intl.DateTimeFormat("th-TH", {
                                            day: "2-digit",
                                            month: "2-digit",
                                            year: "numeric",
                                        }).format(new Date(properties["วันที่เซ็นอนุมัติ(จ่ายงาน)"]?.date?.start))
                                        : "\u00A0".repeat(25)}
                                    ㅤ
                                </span>
                            </p>
                        ...
                        <div className='grid gap-2'>
                            <p className='relative'>ผู้อนุมัติ(จ่ายเงิน) : ............................................
                                {properties?.["ผู้อนุมัติ(จ่ายเงิน)"]?.files?.[0]?.external?.url && (
                                    <img
                                        className="absolute -top-12 h-24 left-32"
                                        src={properties?.["ผู้อนุมัติ(จ่ายเงิน)"]?.files[0]?.external?.url}
                                        alt={properties?.["ผู้อนุมัติ(จ่ายเงิน)"]?.files[0]?.name}
                                    />
                                )}
                            </p>
                            <p>( {properties?.["ชื่อผู้อนุมัติ(จ่ายเงิน)"]?.rich_text?.[0]?.text?.content || "\u00A0".repeat(40)} )</p>
                            <p>วันที่ :
                                <span className="font-medium underline decoration-dotted underline-offset-4 decoration-1.5">
                                    ㅤ
                                    {properties?.["วันที่เซ็นอนุมัติ(จ่ายเงิน)"]?.date?.start
                                        ? new Intl.DateTimeFormat("th-TH", {
                                            day: "2-digit",
                                            month: "2-digit",
                                            year: "numeric",
                                        }).format(new Date(properties["วันที่เซ็นอนุมัติ(จ่ายเงิน)"]?.date?.start))
                                        : "\u00A0".repeat(25)}
                                    ㅤ
                                </span>
                            </p>
