    ...
    return (
        <>
            ...
            <div className='mt-4'>
                ...
                <div className="flex gap-2 text-md justify-center mb-2">
                    <div className='flex gap-2'>วันที่รับงาน : <span className='underline underline-offset-4 font-medium'>{properties?.["วันที่ช่างรับงาน"]?.date?.start}</span></div>
                    <div className='flex gap-2'>วันที่นัดส่งงาน : <span className='underline underline-offset-4 font-medium'>{properties?.["วันที่นัดส่งงาน"]?.date?.start}</span></div>
            ...
            <div className='grid grid-cols-[40%_60%] mt-10'>
            ...
            <div className='justify-center mt-10'>
                ...
                <div className="mt-2 flex gap-2">
                    <div>วันที่วางบิล: <span className='underline font-medium underline-offset-4'>ㅤ{properties?.["วันที่วางบิล"]?.date?.start}ㅤ</span></div>
                    <div>ผู้อนุมัติ(จ่ายงาน):<span className='underline font-medium underline-offset-4'>ㅤ{properties?.["ผู้อนุมัติ(จ่ายงาน)"]?.rich_text[0]?.text?.content}ㅤ</span> </div>
                    <div>ผู้อนุมัติ(จ่ายเงิน): <span className='underline font-medium underline-offset-4'>ㅤ{properties?.["ผู้อนุมัติ(จ่ายเงิน)"]?.rich_text[0]?.text?.content}ㅤ</span></div>
                </div>
                <div className="mt-5">หมายเหตุ: <span>ทางบริษัทจะชำระเงินให้กับช่างในกรณีที่มีการส่งมอบสินค้าเรียบร้อยครบตามใบจ่ายงานช่างเย็บ</span></div>
            </div>
        </>
    )
}
